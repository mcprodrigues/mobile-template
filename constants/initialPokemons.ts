export const initialPokemons = [
  ...
  { name: 'gato', isFound: false, bgCard: '#F4F3EB', bgRight: '#FFD47C' },
  { name: 'iguana', isFound: false, bgCard: '#EDF6EC', bgRight: '#C6D81A' },
  { name: 'pavao', isFound: false, bgCard: '#F1FBF1', bgRight: '#17B584' },
  { name: 'pombo', isFound: false, bgCard: '#F1F8FA', bgRight: '#9AAAD4' },
  { name: 'vaca', isFound: false, bgCard: '#F1F2F3', bgRight: '#E7CDAA' },
];
