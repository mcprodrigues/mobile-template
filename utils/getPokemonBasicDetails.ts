...
export function getPokemonBasicDetails(name: string): PokemonBasicDetails | null {
  ...
  const descriptionMap: Record<string, string> = {
    ...
    camaleao: 'Apesar de ser comumente confundido com lagartos coloridos, o “camaleão” encontrado no campus é, na verdade, o lagarto papa-vento, que muda de cor principalmente para regular a temperatura corporal e comunicar-se. Seu visual exótico chama atenção de quem passa pelos jardins e áreas arborizadas.',
    ...
    iguana: 'Com visual pré-histórico e andar tranquilo, a iguana é uma das moradoras mais exóticas da universidade. Gosta de tomar sol nas árvores ou em áreas mais quentes.',
    ...
    camaleao: 'A cor do "camaleão" não muda conforme o ambiente, como no mito popular, mas sim de acordo com seu humor, temperatura e estado fisiológico.',
